...
> **Revisão:** 2026-07-09 — Modelo Free/Pro, auto-cadastro, limites configuráveis via `system_settings`.
...
| 2 — Tenant | T05–T07 | Resolução de tenant + auth super-admin |
...
| 8 — Limites | T29–T30 | Rebaixamento + banners |
| 9 — Segurança | T31–T34 | Review + testes de isolamento |
